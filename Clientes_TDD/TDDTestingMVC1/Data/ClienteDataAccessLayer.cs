...
namespace TDDTestingMVC1.Data
{
    public class ClienteDataAccessLayer
    {
        ...
        string connectionString = "Server=ANGEL\\SQLEXPRESS;Database=productosdb;User ID=sa;Password=admin;TrustServerCertificate=true;MultipleActiveResultSets=true";
